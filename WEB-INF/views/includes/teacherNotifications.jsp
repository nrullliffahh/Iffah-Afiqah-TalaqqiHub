...
<jsp:include page="/WEB-INF/views/includes/portalTabContext.jsp">
    ...
    <jsp:param name="portalTab" value="teacher"/>
...
<div class="notif-wrap" id="<%= notifPrefix %>Wrap">
    ...
    <div id="<%= notifPrefix %>Menu" class="notif-menu">
        ...
        <div class="notif-menu-foot">
            ...
            <a href="<%= request.getContextPath() %>/teacher/announcements">View all notifications</a>
...
(function() {
    ...
    function fetchNotifications() {
        ...
        return fetch(ctx + '/api/notifications?role=teacher', { credentials: 'same-origin' })
    ...
    window['markAll' + prefix + 'Read'] = function() {
        ...
        fetch(ctx + '/api/notifications/mark-read?role=teacher', { method: 'POST', credentials: 'same-origin' })
